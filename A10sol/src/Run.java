...
class Games {
    ...
    static final ArrayList<Point> point = new ArrayList<>(Arrays.asList(
            new Point(6,3),
            new Point(7,3),
            new Point(4,4),
            new Point(4,5),
...
class BlinkerQuadGame {
    public static void main(String[] args){
        Game blink = new GameQuadTree(16, 100, Games.blinker);
        blink.run();
    }
}
...
class ToadQuadGame {
    public static void main(String[] args){
        Game toad = new GameQuadTree(16, 100, Games.toad);
        toad.run();
    }
}

class BeaconQuadGame {
    public static void main(String[] args){
        Game beacon = new GameQuadTree(16, 100, Games.beacon);
        beacon.run();
    }
}
...
class BusyQuadGame {
    public static void main(String[] args){
        Game busy = new GameQuadTree(64, 100, Games.busy);
        busy.run();
    }
}

class GliderQuadGame {
    public static void main(String[] args){
        Game glide = new GameQuadTree(256, 50, Games.glider);
        glide.run();
    }
}
...
class LabQuestion{
    public static void main(String[] args){
        Game point = new GameMatrix(32,3000, Games.point);
        point.run();
    }
}
